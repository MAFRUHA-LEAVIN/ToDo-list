...
class FirstPage extends React.Component {
  ...
  render() {
    ...
    const Feels = Math.round(this.state.combine.feels_like - 273);
          ...
          <div style={styled.widget}>
            <div style={styled.details}>
              ...
              <div style={styled.city}>
                city: {this.state.city}, country:{this.state.country.country}
              </div>
              ...
              <div style={styled.precipitation}>
                Feels Like: {this.state.combine.feels_like}
              </div>
              <div style={styled.wind}>Wind: 3 mph</div>
            </div>
          </div>
        </div>
      </div>
